<!DOCTYPE.php>
    ...
    <body>
                ...
                <div class="d-flex mt-5 justify-content-center">
                    ...
                    <div class="d-block mt-5">
                        ...
                        <div class="col-md-4 d-flex">
                            <p class="text-center col-md-12 d-block">
                            <div class="kutu_mavi justify-content-end col-md-8 d-flex"></div> &nbsp;&nbsp;İlkokul Mezunu
                        ...
                        <div class="col-md-4 d-flex">
                            <p class="text-center col-md-12 d-block">
                            <div class="kutu_gri justify-content-end col-md-8 d-flex"></div> &nbsp;&nbsp;Üniversite Mezunu
                            <!-- 360 a gore dinamic alinacak-->
                            </p><br>
                        </div>
                    </div>
        ...
        <div class="d-flex justify-content-center">
            <p><b>Yakalanma sıklığına göre hastalıklar</b></p>
        </div>
        <div class="d-flex">
